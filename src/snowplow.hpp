...
public:
   ...
   * @return shared_ptr<Tracker> Shared pointer to the initialized tracker.
   */
  static shared_ptr<Tracker> create_tracker(const TrackerConfiguration &tracker_config, const NetworkConfiguration &network_config, EmitterConfiguration &emitter_config, shared_ptr<Subject> subject = nullptr);
   ...
   * @return shared_ptr<Tracker> Shared pointer to the initialized tracker.
   */
  static shared_ptr<Tracker> create_tracker(const TrackerConfiguration &tracker_config, const NetworkConfiguration &network_config, EmitterConfiguration &emitter_config, SessionConfiguration &session_config, shared_ptr<Subject> subject = nullptr);
