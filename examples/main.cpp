...
int main(int argc, char **argv) {
  ...
  NetworkConfiguration network_config(uri, Method::POST);
  ...
  // Create Tracker
  auto tracker = Snowplow::create_tracker(tracker_config, network_config, emitter_config, session_config, subject);
